...
Galgame 玩家向的工具与网站导航仓库。汇总整理了各种实用的 Galgame 相关工具和优质网站链接，方便玩家快速找到所需资源。同时我们还会制作一系列的工具或模拟器相关使用教程。
...
- [资源管理](tools/README.md#资源管理)（类似游戏仓库，专门管理本地的游戏及存档）
- [乱码转区](tools/README.md#乱码转区)（专门解决游戏出现乱码的情况）
- [汉化翻译](tools/README.md#汉化翻译)（还未汉化的游戏专用工具）
- [优化工具](tools/README.md#优化工具)（提升游戏体验的工具）
